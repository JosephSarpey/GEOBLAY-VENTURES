    ...
    <div className="fixed z-50 bottom-6 right-6 flex flex-col items-end space-y-3">
      {open && (
        <div className="flex flex-col items-end mb-2 space-y-2">
          <a
            href="https://wa.me/919872926176"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center px-4 py-2 bg-green-500 text-white rounded-lg shadow-lg hover:bg-green-600 transition"
          ...
          <a
            ...
            className="flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg shadow-lg hover:bg-blue-700 transition"
            aria-label="Call us"
          >
      ...
      <button
        className="flex items-center justify-center w-14 h-14 rounded-full bg-gradient-to-br from-green-500 to-blue-600 text-white shadow-lg hover:scale-105 transition"
        onClick={() => setOpen((o) => !o)}
